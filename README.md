...
An example with files can be found in **[Example](/PhHermann/LDJump/Examples)**. We provide a set of Lookup-Tables of LDHat in **[Lookup Tables](/PHHermann/LDJump/Lookups)**. 
