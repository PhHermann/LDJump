...
A logical parameter *demography*, which is *FALSE* by default, enables to estimate the recombination rates using on a GAM which is based on simulated samples of populations undergoing demographic effects. 
